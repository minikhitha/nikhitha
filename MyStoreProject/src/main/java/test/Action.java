...
public class Action extends BaseClass implements ActionInterface {
	...
	public boolean isDisplay(WebDriver driver , String element,String locator) {
     boolean result =false;
		switch(locator) {
		case "id": result=driver.findElement(By.id(element)).isDisplayed();
		break ;
		case "xpath": result=driver.findElement(By.xpath(element)).isDisplayed();
		break;
		}
	...
	public void click(WebDriver driver , String element,String locator) {
	    switch(locator) {
